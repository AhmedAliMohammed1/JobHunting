...
export async function GET() {
  ...
  if ([saved, applications, unread, profile, automation].some((result) => result.error)) return NextResponse.json({ error: "Could not load the workspace summary." }, { status: 500 });
